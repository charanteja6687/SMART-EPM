...
The **Smart Employee & Project Management System** is a full-stack web application for managing employees, projects, and tasks with secure role-based access control (**Admin** / **Employee**). The backend is built using **Spring Boot 3.2**, **Spring Security (JWT)**, and **MySQL 8**, while the frontend uses **React 18**, **Material UI (MUI)**, and **Axios**.

---

## 1. Overview

This application helps organizations manage employees, projects, and daily tasks from a single platform. 

* **Administrators** can manage employees, assign projects and tasks, monitor progress, generate reports, and view activity logs.
* **Employees** have access only to the projects and tasks assigned to them.
